...
export class MediaLib extends Plugin {
  handleToggle = null;
  ...
  init() {
    ...
    editor.ui.componentFactory.add("mediaLib", () => {
  ...
  toggle() {
    if (typeof this.handleToggle !== "function") {
      throw new Error(
        "Media library toggle function not connected. Use connect function first"
      );
    }
